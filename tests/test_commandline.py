...
from koala.commandline import ParseError, command, Program, field, dataclass
...
class greet:
    ...
    numbers: list[int] = field(doc="favorite numbers", nargs="+")  #, converter=list[int])
...
def test_pipeline_program():
    ...
    args = ["greet", "Super", "Bot", "1", "2", "--is_blue", "--language", "Spanish", "greet", "Guy", "Fieri", 8, 19, 77, 92]
    # prog.parse_command_line(args)
