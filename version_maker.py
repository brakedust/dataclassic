...
class GitVersionInfo:
    ...
    def __str__(self):
        return "{0}.{1}.{2}+{3}".format(self.major, self.minor, self.release, self.committish)
        ...
        try:
            try:
                ...
                if repo_path:
                    ...
                    # os.chdir(repo_path)
                git_version_string = subprocess.check_output('git describe --long',
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, str):
            ...
            return (self.major == other.major) and (self.minor == other.minor) and \
                (self.release == other.release) and (self.committish == other.committish)
...
if __name__ == "__main__":
    ...
    new_file = os.path.join(my_path, 'koala', 'version.py')
    GitVersionInfo.save(v, new_file)
